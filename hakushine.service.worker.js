...
/** @type {string} */
const CACHE_VERSION = '1781346018|64514929';
/** @type {string} */
const CACHE_PREFIX = 'hakushine-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'hakushine.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["hakushine.html","hakushine.js","hakushine.offline.html","hakushine.icon.png","hakushine.apple-touch-icon.png","hakushine.audio.worklet.js","hakushine.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["hakushine.wasm","hakushine.pck"];
